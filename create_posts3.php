...
foreach ($new_urls_thema as $url)
{
	...
	//HTML
	$post_html_all .= sprintf($post_html, $titles[$i], $screenshots[$i], $tags, $filesinfo_html[$i], $new_urls_imacros[$i], $screenshots_small[$i]);


	//IMACROS
	$post_imacros_single_line = sprintf($post_imacros, $titles[$i], $titles[$i], $screenshots[$i], $tags, $filesinfo_html[$i], $new_urls_imacros[$i], $screenshots_small[$i]);
	$post_imacros_single_line .= PHP_EOL;
	$post_imacros_all .= $post_imacros_single_line;


	//THEMA
	$post_thema_single_line = sprintf($post_thema, $titles[$i], $titles[$i], $screenshots[$i], $tags, $filesinfo_text[$i], $url, $screenshots_small[$i]);
