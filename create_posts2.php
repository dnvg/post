...
$post_imacros .= "%s<BR><BR>";
$post_imacros .= "[b]Download:[/b]<BR>";
$post_imacros .= "%s<BR><BR>";
$post_imacros .= "%s<BR>";
$post_imacros .= "%s\"";

$post_thema = "<subject>%s</subject>\n\n";
$post_thema .= "[b]%s[/b]\n\n";
$post_thema .= "%s\n\n";
$post_thema .= "[b]Tags:[/b]\n";
$post_thema .= "[i]%s[/i]\n\n";
...
foreach ($new_urls_thema as $url)
{
	...
	//HTML
	$post_html_all .= sprintf($post_html, $titles[$i], $screenshots[$i], $tags, $filesinfo_html[$i], $new_urls_imacros[$i], $gifs[$i], $screenshots_small[$i]);


	//IMACROS
	$post_imacros_single_line = sprintf($post_imacros, $titles[$i], $titles[$i], $screenshots[$i], $tags, $filesinfo_html[$i], $new_urls_imacros[$i], $gifs[$i], $screenshots_small[$i]);
	$post_imacros_single_line .= PHP_EOL;
	$post_imacros_all .= $post_imacros_single_line;


	//THEMA
	$post_thema_single_line = sprintf($post_thema, $titles[$i], $titles[$i], $screenshots[$i], $tags, $filesinfo_text[$i], $url, $gifs[$i], $screenshots_small[$i]);
